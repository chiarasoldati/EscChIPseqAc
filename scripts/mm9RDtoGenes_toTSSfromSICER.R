...
vals <- rd.df[,c("names","values.nTags_ChIP","values.nTags_Cnt","values.neg10log10pVal","values.FoldEnrichment","values.FDR")]
colnames(vals) <- c("Names","nTags_ChIP","nTags_Cnt","neg10log10pVal","FoldEnrichment","FDR")
